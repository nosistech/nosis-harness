...
|---|---|---|---|---|
| DeepSeek | Direct model API | Prompt/system/history/tool data needed for the turn | User-billed; catalog recheck deadline 2026-08-02 | Remove key and select another route |
| Moonshot/Kimi | Direct model API | Same; multimodal inputs on capable routes | User-billed; catalog recheck deadline 2026-08-02 | Remove key and select another route |
| Xiaomi/MiMo | Direct model API | Same | User-billed; catalog recheck deadline 2026-08-02 | Remove key and select another route |
| Z.AI/GLM | Direct model API | Same | User-billed; some routes currently listed free; recheck 2026-08-02 | Remove key and select another route |
