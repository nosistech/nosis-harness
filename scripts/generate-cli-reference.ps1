...
$Document.Add('Reasoning defaults vary by route and can be `max`. On GLM 5.3 routes,')
$Document.Add('`--think none` becomes `low`; reasoning stays enabled and can incur charges.')
$Document.Add('See [model updates](MODEL_UPDATES.md) before selecting those routes.')
$Document.Add('')
